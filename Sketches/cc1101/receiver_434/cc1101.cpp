...
void CC1101::setDefaultRegs(void) 
{
  ...
  // Set default carrier frequency = 434 MHz
  setCarrierFreq(CFREQ_434);
...
void CC1101::setCarrierFreq(byte freq)
{
  switch(freq)
  {
    ...
    default:
      writeReg(CC1101_FREQ2,  CC1101_DEFVAL_FREQ2_434);
      writeReg(CC1101_FREQ1,  CC1101_DEFVAL_FREQ1_434);
      writeReg(CC1101_FREQ0,  CC1101_DEFVAL_FREQ0_434);
      break;
  }
